...
def test_url_determines_folder():
    ...
    # Test case 1: URL code 12217 should always return 柏市 (SumStock uses 12217 for Kashiwa)
    ...
    print("✓ URL code 12217 correctly returns 千葉県/柏市")
    
    # Test case 2: URL code 12215 should always return 旭市 (SumStock uses 12215 for Asahi)
    pref, city = get_location_from_url('https://sumstock.jp/search/02/12/12215')
    assert pref == '千葉県', f"Expected '千葉県', got '{pref}'"
    assert city == '旭市', f"Expected '旭市', got '{city}'"
    print("✓ URL code 12215 correctly returns 千葉県/旭市")
    ...
    # Test case 4: URL code 12217 should return 柏市 (SumStock mapping, not JIS standard)
    # This is the key behavior: URL code takes precedence and SumStock 12217 = 柏市
    address_pref, address_city = parse_location_from_address('旭市ハ', '')
    assert address_city == '旭市', f"Address parsing returned '{address_city}', expected '旭市'"
    
    # URL code 12217 should return 柏市 (SumStock's mapping for Kashiwa)
    url_pref, url_city = get_location_from_url('https://sumstock.jp/search/02/12/12217')
    assert url_city == '柏市', f"URL code 12217 should return '柏市', got '{url_city}'"
